...
import 'package:imitate_yay/net/http/interceptor/my_error_interceptor.dart';
import 'package:imitate_yay/net/http/interceptor/request_interceptor.dart';
import 'package:imitate_yay/net/http/interceptor/retry_interceptor.dart';
...
class Http {
  ...
  Http._internal() {
    ...
    // // 添加cache拦截器
    dio.interceptors.add(MyCacheInterceptor());
    // // 添加retry拦截器
